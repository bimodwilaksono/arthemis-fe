import { TextInput, PasswordInput, Button, Anchor, Paper, Title, Text, Container } from '@mantine/core'
    ...
    return (
        <Container size={420} my={40}>
            ...
            <Paper withBorder shadow="md" p={30} mt={30} radius="md">
                ...
                >
                    <TextInput label="Email" placeholder={'Input Your Email'} required {...getInputProps('email')} />
                    <PasswordInput
                        label="Password"
